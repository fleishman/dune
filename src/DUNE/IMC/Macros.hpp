...
//! CorrectedState identification number.
#define DUNE_IMC_CORRECTEDSTATE 850
//! DataParticle identification number.
#define DUNE_IMC_DATAPARTICLE 851
//! DataMBS identification number.
